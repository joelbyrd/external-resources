...
function humanReadTrackingNo(trkin) {
    return trkin.substr(0, 4) + "&nbsp;" + trkin.substr(4, 4) + "&nbsp;" + trkin.substr(8, 4) + "&nbsp;" + trkin.substr(12, 4)  +
        "&nbsp;" + trkin.substr(16, 4) + "&nbsp;" + trkin.substr(20,4)  + "&nbsp;" + trkin.substr(24,1) + mod10(trkin.toUpperCase().trim());
}
...
var allLabelDefinitions = function(){
	...
	this.loadDataUPSS = function(){
 	...
 	this.loadDataPurolator = function () {
		...
		outshipArray.push(addparts[0] + " " + addparts[1] + " " + zip);
...
"</div>"; //inner not needed -></div>";
	...
	this.printLabelUPS = function(){
		...
		if (this.missingData.length > 0){
			...
			"			<span >" + upsInfo.orderSMDesc.toUpperCase() + "</span><br/>" + //this.labelInfo.shipMethodDesc.toUpperCase() + "</span><br/>" + 
			...
			"		<div class='adult'>" + upsInfo.adultSignature + " &nbsp;</div>" +
			"		<div class='ref'>REF: # " + upsInfo.refPrinted + " 	Ship Date: " + upsInfo.shipDate +  "  </div>" + upsInfo.invPrinted +
			"	</div>	" +
			" </div>"; // close inner ups div
