 ...
 * Use parseFloatIgnoreCommaCurrency() instead which handles multiple currency symbols
 * 
...
// strips commas (,) and other currency symbols including dollar, euro, pound,yen and so on and returns float
function parseFloatIgnoreCommaCurrency(number) {
    var tmpNumber = "";
    ...
    if (typeof tmpNumber === "string") {
        var numberNoCommas = tmpNumber.replace(/[,\$\xA2-\xA5\u058F\u060B\u09F2\u09F3\u09FB\u0AF1\u0BF9\u0E3F\u17DB\u20A0-\u20BD\uA838\uFDFC\uFE69\uFF04\uFFE0\uFFE1\uFFE5\uFFE6]/g, '');
        return parseFloat(numberNoCommas);
    } else if (typeof tmpNumber === "number") {
        return parseFloat(tmpNumber);
    }
